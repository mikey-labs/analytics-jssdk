...
MurmurHash3.x86.hash32 = function (key: string, seed: number) {
  //
...
MurmurHash3.x86.hash128 = function (key: string, seed: number) {
  //
...
MurmurHash3.x64.hash128 = function (key: string, seed: number) {
  //
  // Given a string and an optional seed as an int, returns a 128 bit
